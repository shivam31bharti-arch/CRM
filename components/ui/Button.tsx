  ...
  ({ className, variant = "primary", ...props }, ref) => {
    ...
    return (
      <button
        ref={ref}
        className={cn(
          "focus-ring inline-flex h-9 items-center justify-center gap-2 rounded-md px-3 text-sm font-medium transition disabled:pointer-events-none disabled:opacity-50",
          variants[variant],
          className
        )}
        {...props}
